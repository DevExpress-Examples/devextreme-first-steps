<template>
  <div id="dashboard">
    ...
    <DxDataGrid id="task-grid" :data-source="tasks" @row-updated="updateProgress" @row-inserted="updateProgress"
      @row-removed="updateProgress">
      <DxColumn data-field="task" />
      <DxColumn data-field="dueDate" />
      <DxColumn data-field="done" />
      <DxEditing mode="row" :allow-updating="true" :allow-adding="true" :allow-deleting="true"
